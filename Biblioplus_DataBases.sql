...
CREATE DATABASE IF NOT EXISTS biblioplus /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci */;
USE biblioplus;
...
select * from usuario;
select * from libro;
autorclientesautorselect * from autor;
---
CREATE TABLE IF NOT EXISTS usuario (
  usuarioID int(11) NOT NULL AUTO_INCREMENT,
  nombre_usuario varchar(120) NOT NULL,
...
ALTER TABLE usuario MODIFY COLUMN es_admin BOOLEAN NULL DEFAULT FALSE;
